        ...
        <div className="flex flex-col gap-1">
            ...
            <div>
                ...
                <div className="flex flex-row gap-2 items-center">
                   {userInfo?.discordHandle ?<p>{userInfo?.discordHandle}</p>  : <SingInButtonDiscord /> }
            ...
            <div>
                ...
                <div className="flex flex-row gap-2 items-center">
                   {userInfo?.twitterHandle ? <p>{userInfo?.twitterHandle}</p>  : <SingInButtonTwitter /> }
            ...
            <div>
                ...
                <div className="flex flex-row gap-2 items-center">
                   {userInfo?.ton_address ? <p>{userInfo?.ton_address}</p>  : <SingInButtonTON /> }
